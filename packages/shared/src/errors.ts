...
export const DEFAULT_ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  [ErrorCode.AUTH_INVALID_TOKEN]: 'Your session has expired. Please log in again.',
  [ErrorCode.AUTH_USER_NOT_FOUND]: 'Account not found.',

  // Session
  [ErrorCode.SESSION_NOT_FOUND]: 'This session was not found. It may have been deleted.',
  [ErrorCode.SESSION_SETTLED]: 'This session has already been settled.',
  [ErrorCode.SESSION_NOT_SETTLED]: 'This session is not settled.',
  [ErrorCode.SESSION_DELETE_FORBIDDEN]: 'Only the session creator can delete this session.',
  [ErrorCode.SESSION_SETTLE_FORBIDDEN]: 'Only the session creator can settle this session.',
  [ErrorCode.SESSION_UNSETTLE_FORBIDDEN]: 'Only the session creator can undo settlement.',
  [ErrorCode.SESSION_EDIT_FORBIDDEN]: 'Only the session creator can edit items.',
  [ErrorCode.SESSION_KICK_FORBIDDEN]: 'Only the session creator can remove participants.',
  [ErrorCode.SESSION_KICK_ACTIVE_ONLY]: 'Participants can only be removed from active sessions.',
  [ErrorCode.SESSION_ITEMS_NOT_ALL_CLAIMED]: 'All items must be claimed before settling.',
  [ErrorCode.SESSION_CODE_GENERATION_FAILED]: 'Failed to generate a session code. Please try again.',
  ...
  [ErrorCode.RECEIPT_SCAN_FAILED]: 'Failed to scan the receipt. Please try again or enter items manually.',

  // Generic
  [ErrorCode.VALIDATION_FAILED]: 'Please check your input and try again.',
  [ErrorCode.DATABASE_UNAVAILABLE]: 'The service is temporarily unavailable. Please try again later.',
